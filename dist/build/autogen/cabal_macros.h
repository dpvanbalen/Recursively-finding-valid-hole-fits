...
/* package hfplugin-0.1.0.0 */
#ifndef VERSION_hfplugin
#define VERSION_hfplugin "0.1.0.0"
#endif /* VERSION_hfplugin */
#ifndef MIN_VERSION_hfplugin
#define MIN_VERSION_hfplugin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hfplugin */
